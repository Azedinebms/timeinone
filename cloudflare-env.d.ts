/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: dbadf8682a856f50501f9b863d63ef5c)
...
interface __BaseEnv_CloudflareEnv {
	...
	NEXT_PUBLIC_LEGAL_STATUS: string;
	NEXT_PUBLIC_LEGAL_ADDRESS: string;
	NEXT_PUBLIC_LEGAL_REGISTRATION_NUMBER: string;
	NEXT_PUBLIC_LEGAL_TAX_NUMBER: string;
	NEXT_PUBLIC_PUBLICATION_DIRECTOR: string;
	NEXT_PUBLIC_GOVERNING_COUNTRY: string;
	NEXT_PUBLIC_HOSTING_PROVIDER: string;
	NEXT_PUBLIC_HOSTING_ADDRESS: string;
	NEXT_PUBLIC_HOSTING_WEBSITE: string;
	ALLOW_SEARCH_INDEXING: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "NEXT_PUBLIC_SITE_URL" | "NEXT_PUBLIC_CONTACT_EMAIL" | "NEXT_PUBLIC_LEGAL_NAME" | "NEXT_PUBLIC_LEGAL_STATUS" | "NEXT_PUBLIC_LEGAL_ADDRESS" | "NEXT_PUBLIC_LEGAL_REGISTRATION_NUMBER" | "NEXT_PUBLIC_LEGAL_TAX_NUMBER" | "NEXT_PUBLIC_PUBLICATION_DIRECTOR" | "NEXT_PUBLIC_GOVERNING_COUNTRY" | "NEXT_PUBLIC_HOSTING_PROVIDER" | "NEXT_PUBLIC_HOSTING_ADDRESS" | "NEXT_PUBLIC_HOSTING_WEBSITE" | "ALLOW_SEARCH_INDEXING">> {}
}
